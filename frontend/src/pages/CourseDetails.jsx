...
const CourseDetails = () => {
        ...
        const fetchCourseData = async () => {
            try {
                ...
                if (courseRes.data.data.modules) {
                    setExpandedModules(
                        courseRes.data.data.modules.map((m) => m._id)
                    );
                }
    ...
    const startLesson = async (lesson, moduleId) => {
        if (!enrollment) {
            await handleEnroll();
            return;
        }
        ...
        try {
            ...
            navigate(`/session/${sessionRes.data.session._id}`);
        } catch (err) {
                        ...
                        <div className="lg:col-span-2">
                            ...
                            <div className="flex items-center space-x-6 text-sm">
                                ...
                                <div className="flex items-center space-x-2">
                                    ...
                                    <span>
                                        {Math.ceil(course.statistics.totalDuration / 60)} hours
                                    </span>
                                </div>
                            </div>
                        </div>
                                ...
                                {enrollment ? (
                                            ...
                                            onClick={() => {
                                                if (enrollment.progress.currentLesson) {
                                                    ...
                                                    const currentLesson = course.modules
                                                        ...
                                                        .find(
                                                            (l) =>
                                                                l._id === enrollment.progress.currentLesson
                                                        );
                                                    if (currentLesson) {
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600 mb-6">
                                            Enroll in this course to access all lessons and start learning
                                            with AI-powered voice tutoring.
                                        </p>
                                        <button
                                                ...
                                                <div className="flex items-center space-x-3">
                                                    ...
                                                    <div className="text-left">
                                                        ...
                                                        <p className="text-sm text-gray-500">
                                                            {module.statistics.totalLessons} lessons •{' '}
                                                            {Math.ceil(module.statistics.totalDuration / 60)}{' '}
                                                            min
                                                        </p>
                                                    </div>
                                                </div>
