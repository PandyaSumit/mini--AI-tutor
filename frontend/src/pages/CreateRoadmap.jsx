...
const CreateRoadmap = () => {
    ...
    const learningModes = [
        ...
        { value: 'text', label: 'Reading', icon: BookOpen },
        { value: 'hands-on', label: 'Practice', icon: Zap },
            ...
            <div className="max-w-3xl mx-auto px-6 lg:px-8 py-8 lg:py-10">
                        ...
                        {steps.map((s, index) => (
                            <div key={s.number} className="flex items-center flex-1">
                                <div className="flex flex-col items-center flex-1">
                                    <div
                                        className={`w-10 h-10 rounded-full flex items-center justify-center font-semibold text-sm transition-all mb-2 ${s.number === step
                                    ...
                                    <span className={`text-xs font-medium ${s.number === step ? 'text-gray-900' : 'text-gray-500'
                                        }`}>
                                        {s.label}
                                    </span>
                                </div>
                                {index < steps.length - 1 && (
                                    <div
                                        className={`h-0.5 flex-1 mx-2 transition-all ${s.number < step ? 'bg-gray-900' : 'bg-gray-200'
                                            }`}
                                    />
                                )}
                            </div>
                        ...
                        <div className="space-y-8">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    {levels.map(level => (
                                        <button
                                            ...
                                            className={`p-5 border rounded-xl text-left transition-all ${formData.currentLevel === level.value
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-6">
                                    ...
                                    <div className="text-3xl font-bold text-gray-900 min-w-[100px] text-center">
                                        {formData.weeklyTimeCommitment} <span className="text-lg text-gray-500">hrs</span>
                                    </div>
                                </div>
                                <p className="text-sm text-gray-500 mt-2">
                            ...
                            <div>
                                <label className="flex items-center gap-2 text-lg font-semibold text-gray-900 mb-3">
                                    ...
                                    Target completion date <span className="text-sm font-normal text-gray-500">(optional)</span>
                                </label>
                                <input
                                    type="date"
                                    ...
                                    {learningModes.map(mode => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`p-6 border rounded-xl text-center transition-all relative ${isSelected
                                                    ? 'border-gray-900 bg-gray-50'
                                                    : 'border-gray-200 hover:border-gray-900 hover:bg-gray-50'
                                                    }`}
                                            >
                                                ...
                                                <div className={`w-12 h-12 rounded-lg flex items-center justify-center mx-auto mb-3 ${isSelected ? 'bg-gray-900' : 'bg-gray-100'
                                                    }`}>
                ...
                <div className="mt-6 text-center">
                    <p className="text-sm text-gray-500">
                        This usually takes 10-15 seconds. We're analyzing your goals and creating a personalized roadmap.
                    </p>
                </div>
            </div>
        </div>
