...
const MyRoadmaps = () => {
    ...
    console.log('filteredRoadmaps :>> ', filteredRoadmaps);
                        ...
                        <div className="flex gap-2 overflow-x-auto pb-2 sm:pb-0">
                            {[
                                ...
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-lg font-medium text-sm whitespace-nowrap transition-all ${statusFilter === filter.value
