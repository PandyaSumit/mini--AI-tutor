      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="perspective-1000 mb-8">
          ...
          >
            {/* Front */}
            <div
              className={`absolute inset-0 card flex flex-col items-center justify-center text-center p-8 backface-hidden ${
                flipped ? 'invisible' : ''
              }`}
            >
            ...
            {/* Back */}
            <div
              className={`absolute inset-0 card flex flex-col items-center justify-center text-center p-8 backface-hidden rotate-y-180 ${
                !flipped ? 'invisible' : ''
              }`}
            >
