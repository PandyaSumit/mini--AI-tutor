...
export default function CreateCoursePage() {
  ...
  const handleCheckSimilar = async () => {
    ...
    try {
      ...
      const response = await courseService.checkSimilar({
        prompt,
        level,
      });
      ...
      if (response.similarCourses.length === 0) {
  ...
  const handleGeneratePreview = async () => {
    try {
      ...
      const response = await courseService.generatePreview({
        prompt,
        level,
        numModules,
      });
  ...
  const handleGenerateCourse = async () => {
    try {
      ...
      const response = await courseService.generate({
        prompt,
        level,
        numModules,
        lessonsPerModule,
  ...
  const handlePublish = async () => {
    ...
    try {
      await courseService.publishCourse(generatedCourse._id);
      router.push(`/courses/${generatedCourse._id}`);
    } catch (err) {
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Create Course with AI</h1>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
            ...
            <div className="mb-6">
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
              <p className="text-sm text-gray-500 mt-1">Recommended: 5 modules (1-10 allowed)</p>
            </div>
            ...
            <div className="mb-6">
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
              <p className="text-sm text-gray-500 mt-1">Recommended: 4 lessons (1-8 allowed)</p>
            </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
            <div className="mb-6">
              <div className="flex items-center space-x-2 mb-2">
                ...
                <h2 className="text-2xl font-bold text-gray-900">Similar Courses Found!</h2>
              </div>
              <p className="text-gray-600">
                We found {similarCourses.length} existing course
                {similarCourses.length > 1 ? 's' : ''} similar to what you&apos;re looking for.
                Consider enrolling in one of these high-quality courses instead of creating a
                duplicate.
              </p>
            </div>
                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4 text-sm text-gray-500">
                      ...
                      <span
                        className={`px-2 py-1 text-xs rounded capitalize border ${getLevelColor(
                          course.level
                        )}`}
                      >
                        {course.level}
        ...
        {step === 4 && loading && (
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
            ...
            <p className="text-gray-600">
              AI is creating {numModules} modules with {lessonsPerModule} lessons each. This may take
              30-60 seconds.
            </p>
          </div>
        )}
        ...
        {step === 5 && success && generatedCourse && (
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600">Your AI-generated course is ready to publish</p>
            </div>
            ...
            <div className="flex space-x-4">
              <button
                onClick={() => router.push(`/courses/${generatedCourse._id}`)}
                className="flex-1 px-6 py-3 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors font-medium"
              >
                Review Course
              </button>
