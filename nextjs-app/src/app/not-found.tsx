    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 flex items-center justify-center p-6">
      <div className="max-w-4xl w-full">
        ...
        <div className="text-center mb-12 animate-scale-in">
          ...
          <div className="relative inline-block">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
              <div className="relative">
                ...
                <Sparkles
                  className="absolute -bottom-2 -left-6 w-6 h-6 text-blue-400 animate-pulse-subtle"
                  style={{ animationDelay: '0.5s' }}
                />
                <Sparkles
                  className="absolute top-1/2 -right-8 w-5 h-5 text-purple-400 animate-pulse-subtle"
          ...
          {/* Text Content */}
          <div
            className="mt-8 space-y-4 animate-slide-up"
        ...
        {/* Quick Links Grid */}
        <div
          className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8 animate-slide-up"
