 ...
 * Navigation sidebar specifically for platform author pages
 */
...
const authorNavItems: NavItem[] = [
  {
    ...
    match: (path) => path === "/author/dashboard",
  },
  {
    to: "/author/curriculum",
    label: "Curriculum Builder",
    icon: BookOpen,
    match: (path) => path.startsWith("/author/curriculum"),
    badge: "Pro",
  },
  {
    to: "/author/content",
    ...
    icon: Pen,
    match: (path) => path.startsWith("/author/content"),
  },
  {
    to: "/author/library",
    label: "Content Library",
    icon: Library,
    match: (path) => path.startsWith("/author/library"),
  },
  {
    to: "/author/publish",
    label: "Publishing Queue",
    icon: Send,
    match: (path) => path.startsWith("/author/publish"),
  },
  {
    to: "/author/analytics",
    label: "Analytics",
    icon: BarChart3,
    match: (path) => path.startsWith("/author/analytics"),
  },
];

// Learning section (authors can also be students)
          ...
          <div className="flex items-center justify-between">
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[11px] text-purple-600 dark:text-purple-500 font-medium flex items-center gap-1">
        ...
        <div className="px-5 pb-4 pt-3">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-12 py-2 text-[13px] bg-slate-50 dark:bg-[#1a1a1a] border border-slate-200/70 dark:border-[#2a2a2a] rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500/80 dark:focus:ring-purple-500/70 focus:border-transparent transition-all placeholder:text-slate-400 dark:placeholder:text-[#888888]"
            />
      ...
      >
        <div className={`space-y-1 ${collapsed && !isMobile ? "" : ""}`}>
          ...
          {user && (
            ...
            >
              <div className={`${collapsed && !isMobile ? "w-8 h-8" : "w-8 h-8"} rounded-full bg-gradient-to-br from-purple-600 to-purple-700 flex items-center justify-center text-white font-semibold text-sm flex-shrink-0`}>
...
export default function AuthorSidebar({ collapsed, setCollapsed }: SidebarProps) {
  return (
    <aside
